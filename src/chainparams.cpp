...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000542b768430790e85e7df45126e0e57ce376ed2bd045605bccc03fb1ce6a"))
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 26210;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // VICE starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 4000000;
        nMaxReorganizationDepth = 100;
        nEnforceBlockUpgradeMajority = 9999999;
        nRejectBlockOutdatedMajority = 950;
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // VICE: 1 day
        nTargetSpacing = 1 * 60;  // VICE: 1 minute
        nMaturity = 50;
        nMasternodeCountDrift = 20;
        nMaxMoneyOut = 1900000000 * COIN;
		vXDNADevKey = ParseHex("02aa695bebbf3cc1e87ca708581e913bd31febf0018cc1370805412236857bbcab"); 
        vXDNAFundKey = ParseHex("0329b08dd9a751b9dcbf63802c366552da8056bd05224dd1dbeef2e1f56c4a1572");
        nDevFee = 5;
        nFundFee = 5;
        nDevFundForkBlock = 1002; // block that start paying dev and fund %
        ...
        nZerocoinStartTime = 1929726034; // never
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "January 21st 2020 - Vice chain started here";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1579647225;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 102916;

		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("00000542b768430790e85e7df45126e0e57ce376ed2bd045605bccc03fb1ce6a"));
        assert(genesis.hashMerkleRoot == uint256("27cba84a949f7a364c95b2f6de8c083f2b8b39e4d1a792b97cab00317549f475"));

	vSeeds.push_back(CDNSSeedData("1", "104.238.135.93"));   // Single node address
    vSeeds.push_back(CDNSSeedData("2", "8.9.3.101"));        // Single node address
    vSeeds.push_back(CDNSSeedData("3", "104.156.250.74"));   // Single node address
    vSeeds.push_back(CDNSSeedData("4", "45.77.221.94"));     // Single node address
	vSeeds.push_back(CDNSSeedData("5", "45.63.0.89"));       // Single node address
	vSeeds.push_back(CDNSSeedData("6", "45.76.5.188"));      // Single node address
    vSeeds.push_back(CDNSSeedData("7", "140.82.1.214"));     // Single node address
	vSeeds.push_back(CDNSSeedData("8", "45.76.12.192"));     // Single node address 
    vSeeds.push_back(CDNSSeedData("9", "149.28.46.10"));     // Single node address
    vSeeds.push_back(CDNSSeedData("10", "8.9.37.16"));       // Single node address
    vSeeds.push_back(CDNSSeedData("11", "144.202.12.61"));   // Single node address
    vSeeds.push_back(CDNSSeedData("12", "173.199.115.252")); // Single node address
        ...
        strObfuscationPoolDummyAddress = "VUgfNFsM5varq6Aog353u5HV4Y8BCVzT6v";
...
public:
    CTestNetParams()
    {
        ...
        // Testnet vicenetwork BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet vicenetwork BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet vicenetwork BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // VICE: 1 minutes
