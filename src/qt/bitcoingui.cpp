                                                                            ...
                                                                            platformStyle(platformStyle)
{
    ...
    /*if (!uiSettings.contains("enableZerocoin")) {
      ...
      zNotif.setWindowTitle("VICE Core - Zerocoin");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VN: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a VN: URI or payment request"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the VICE network", "", count));
}
