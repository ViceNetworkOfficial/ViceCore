...
In order to support loading of multiple wallets in vicenetwork-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vicenetwork.cpp.
...
Changes to vicenetwork.cpp
----------------------
vicenetwork.cpp is the entry point into vicenetwork-qt, and as such, will require some minor modifications to provide hooks for
