...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ViceNetwork Core vicenetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vicenetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vicenetwork transaction") + "\n" +
                               "  vicenetwork-tx [options] -create [commands]   " + _("Create hex-encoded vicenetwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vicenetwork transaction
